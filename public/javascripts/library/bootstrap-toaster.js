...
TOAST_TEMPLATE.innerHTML = `
        <div class="toast-header">
            ...
            <div class="snackbarProgress"></div>
        </div>
        `;
...
class Toast {
    ...
    static setStatus(toastEl, status) {
        ...
        switch (status) {
            ...
            case "success":
                statusIcon.classList.add("text-success", "bi-check-circle");
                break;
            case TOAST_STATUS.DANGER:
            case "danger":
                statusIcon.classList.add("text-danger", "bi-x-circle");
                toastEl.setAttribute("role", "alert");
                toastEl.setAttribute("aria-live", "assertive");
                break;
            case TOAST_STATUS.WARNING:
            case "warning":
                statusIcon.classList.add("text-warning", "bi-exclamation-circle");
                toastEl.setAttribute("role", "alert");
                toastEl.setAttribute("aria-live", "assertive");
                break;
            case TOAST_STATUS.INFO:
            case "info":
                statusIcon.classList.add("text-info", "bi-info-circle");
                break;
            default:
