...
object Notification {
  ...
  val SEND_COIN_FROM_ACCOUNT_FAILED: Notification = Notification("SEND_COIN_FROM_ACCOUNT_FAILED", sendEmail = false, sendPushNotification = true, sendSMS = false, route = None)
