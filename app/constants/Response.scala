...
object Response {
  ...
  val KEY_PROVISION_STATE_UNKNOWN = new Failure("KEY_PROVISION_STATE_UNKNOWN")
  ...
  val CANNOT_CREATE_MORE_ALLOWED_WHITELISTS = new Failure("CANNOT_CREATE_MORE_ALLOWED_WHITELISTS")
  ...
  val NOT_VERIFIED_CREATOR = new Failure("NOT_VERIFIED_CREATOR")
  val COLLECTION_NOT_FOUND = new Failure("COLLECTION_NOT_FOUND")
  val COLLECTION_NOT_PUBLIC = new Failure("COLLECTION_NOT_PUBLIC")
  val FRACTIONALIZED_COLLECTION_NOT_ALLOWED = new Failure("FRACTIONALIZED_COLLECTION_NOT_ALLOWED")
  ...
  val NFT_WHITELIST_SALE_NOT_FOUND = new Failure("NFT_WHITELIST_SALE_NOT_FOUND")
  val NFT_PUBLIC_LISTING_SALE_NOT_FOUND = new Failure("NFT_PUBLIC_LISTING_SALE_NOT_FOUND")
  ...
  val NFT_TOTAL_SUPPLY_AND_OWNED_DIFFERENT = new Failure("NFT_TOTAL_SUPPLY_AND_OWNED_DIFFERENT")
  ...
  val TRANSACTION_BROADCASTING_FAILED_AND_TIMED_OUT = new Failure("TRANSACTION_BROADCASTING_FAILED_AND_TIMED_OUT")
  ...
  val ADDRESS_ALREADY_PROVISIONED = new Failure("ADDRESS_ALREADY_PROVISIONED")
  ...
  val TRANSACTION_HEIGHT_NOT_FOUND = new Failure("TRANSACTION_HEIGHT_NOT_FOUND")
