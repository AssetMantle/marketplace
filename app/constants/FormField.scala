...
object FormField {
  ...
  val UNMANAGED_ADDRESS_WALLET_NAME = new StringFormField("UNMANAGED_ADDRESS_WALLET_NAME", 3, 50 ,RegularExpression.ACCOUNT_ID)
  ...
  val UNMANAGED_ADDRESS_DEFAULT_MEMO = new StringFormField("UNMANAGED_ADDRESS_DEFAULT_MEMO", 45, 45, RegularExpression.ALL_NUMBERS_ALL_SMALL_LETTERS)
