...
object File {
  ...
  val COLLECTION_DRAFT_FILE_FORM: FileUploadForm = FileUploadForm("COLLECTION_DRAFT_FILE_FORM", get = routes.javascript.CollectionController.uploadCollectionDraftFileForm, store = routes.javascript.CollectionController.storeCollectionDraftFile, upload = routes.javascript.CollectionController.uploadCollectionDraftFile, fileTypes = ALL_IMAGES_WITH_GIF, maxFileSize = 104857600)
  ...
  val NFT_FILE_FORM: FileUploadForm = FileUploadForm("NFT_FILE_FORM", get = routes.javascript.NFTController.uploadNFTFileForm, store = routes.javascript.NFTController.storeNFTFile, upload = routes.javascript.NFTController.uploadNFTFile, fileTypes = ALL_IMAGES_WITH_GIF, maxFileSize = 104857600)
