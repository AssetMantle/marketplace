...
private[history] object MasterSales {
  ...
  class MasterSaleTable(tag: Tag) extends Table[MasterSaleSerialized](tag, "MasterSale") with ModelTable[String] {
    ...
    def * = (id, whitelistId, collectionId, numberOfNFTs, maxMintPerAccount, price, denom, startTimeEpoch, endTimeEpoch, stopped, createdBy.?, createdOnMillisEpoch.?, updatedBy.?, updatedOnMillisEpoch.?, deletedBy.?, deletedOnMillisEpoch.?) <> (MasterSaleSerialized.tupled, MasterSaleSerialized.unapply)
