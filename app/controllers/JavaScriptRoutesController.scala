  ...
  def javascriptRoutes: Action[AnyContent] = Action { implicit request =>
    Ok(
      JavaScriptReverseRouter("jsRoutes")(
        ...
        routes.javascript.PublicListingController.viewPublicListedCollections,
        routes.javascript.PublicListingController.publicListedCollectionsSection,
        routes.javascript.PublicListingController.publicListedCollectionsPerPage,
        ...
        routes.javascript.SaleController.viewWhitelistSaleCollections,
        routes.javascript.SaleController.whitelistSaleCollectionsSection,
        routes.javascript.SaleController.whitelistSaleCollectionsPerPage,
        routes.javascript.SaleController.createCollectionSaleForm,
        routes.javascript.SaleController.buySaleNFTForm,

        routes.javascript.SecondaryMarketController.viewSecondaryMarket,
        routes.javascript.SecondaryMarketController.secondaryMarketCollectionsSection,
        routes.javascript.SecondaryMarketController.secondaryMarketCollectionsPerPage,
