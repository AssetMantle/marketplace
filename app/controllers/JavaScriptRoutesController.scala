  ...
  def javascriptRoutes: Action[AnyContent] = Action { implicit request =>
    Ok(
      JavaScriptReverseRouter("jsRoutes")(
        ...
        routes.javascript.ProfileController.createdWhitelistsPerPage,
        routes.javascript.ProfileController.whitelistTotalMembers,
        routes.javascript.ProfileController.joinedWhitelists,
        routes.javascript.ProfileController.joinedWhitelistsPerPage,
