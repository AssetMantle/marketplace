      ...
      WalletMnemonics.form.bindFromRequest().fold(
        ...
        walletMnemonicsData => {
          ...
          (for {
            ...
            case baseException: BaseException => BadRequest(views.html.account.showWalletMnemonics(walletMnemonicsForm = WalletMnemonics.form.withGlobalError(baseException.failure.message), username = walletMnemonicsData.username, address = walletMnemonicsData.walletAddress, partialMnemonics = Seq(walletMnemonicsData.seed1, walletMnemonicsData.seed2, walletMnemonicsData.seed3, walletMnemonicsData.seed4)))
          }
        }
      )
  }
